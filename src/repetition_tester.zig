...
pub fn repetitionTest() !void {
    ...
    const readArgs = ReadArgs{ .filePath = "./data/data_10000000_flex.json" };

    try runTest(allocator, cpuFreq, "readFile", readArgs, readFile);
}
...
fn readFile(allocator: std.mem.Allocator, comptime args: ReadArgs, bench: *Bench) !void {
